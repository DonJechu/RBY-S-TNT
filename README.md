...
A comprehensive Minecraft Datapack that expands the explosive arsenal of the game with **almost 10 new types of TNT**, each featuring unique survival crafting recipes and specialized destructive behaviors[cite: 1].
...
2. Place it inside the `datapacks` folder of your Minecraft world.
3. Use `/reload` to enable the custom recipes and functions.
4. (Optional) Ensure the associated Resource Pack is active to see the custom 3D models and textures shown in the promotional art[cite: 1].

## 🔧 Technical Details

* **Version:** Compatible with modern Minecraft versions (verify specific `.json` tags).
* **Commands:** Access all items via the custom function: `/function jechu:give_all_tnt`.
